    ...
    <center>
        <div class="main">
            ...
            <div class="body" style="background-image: url(resources/images/background.jpg);">
               ...
               <br/>
                <input style="font-size: 25px; background-color: aqua; border-style: solid; width: 110px; border-radius: 10px; border-color: red;" type="submit" value="Update" />
                   </div>
                        </form>
                </div>
