        ...
        <div class="main">
            ...
            <div class="body" style="background-image: url(resources/images/background.jpg);">
                ...
                <div class="contents">
                    ...
                    %>
                    <br/>
                    <input  formaction="showpaper.jsp" type="submit" value="Next" style="font-size: 25px; background-color: aqua; border-style: solid; width: 90px; margin-right: 20px; border-radius: 10px; border-color: red;" />
                    <input style="font-size: 25px; background-color: aqua; border-style: solid; width: 110px; margin-right: 20px; border-radius: 10px; border-color: red;" type="submit" value="Submit"/>
