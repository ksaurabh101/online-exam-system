            ...
            <div class="body" style="background-image: url(resources/images/background.jpg);">
                ...
                <div class="contents">
                    <div class="login" style="height: auto; margin: 150px 60px 150px 60px; width: 500px;">
                        <div style="color: blue; font-size: 30px; margin-bottom: 10px; background-color: activecaption; "><b>Exam Report</b></div>
                            ...
                            if(user != null)
                            {
                                try
                                {
                                    ...
                                    String q="select * from result where rollno='"+user+"'";
