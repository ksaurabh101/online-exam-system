            ...
            <div class="body" style="background-image: url(resources/images/background.jpg);">
                ...
                <div class="contents">
                    ...
                    <div class="registration">
                        <div style="color: blue; font-size: 30px;margin-bottom: 10px; background-color: activecaption;"><b>User Registration</b></div>
                        <form action="registration" method="post" onSubmit="return verify()" >
                        <table >
                            <tr><td>Full Name:</td><td><input type="text" name="name" id="FullName" placeholder="Your Full Name" /></td></tr>
                            <tr><td>Roll No:</td><td><input type="text" name="rollno" id="RollNo" placeholder="IPG-20XXXXX" /><p style="font-size: 12px;"></p></td></tr>
                            <tr><td>Password:</td><td><input type="password" name="password" id="Password" placeholder="Password"/></td></tr>
                            <tr><td>Confirm Password:</td><td><input type="password" name="password" id="ConfirmPassword" placeholder="ReEnter Password"/></td></tr>
                            ...
                            <tr><td>Email Id:</td><td><input type="text" name="email" id="EmailId" placeholder="Unique Email Id"/></td></tr>
                            <tr><td>Mobile No:</td><td><input type="text" name="mobileno" id="MobileNo" placeholder="Mobile No"/></td></tr>
                        </table>
                            <br/>
