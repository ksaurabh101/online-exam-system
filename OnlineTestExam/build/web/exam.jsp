    ...
    <center>
        <div class="main">
            ...
            <div class="body" style="background-image: url(resources/images/background.jpg);">
                ...
                <div class="contents">
                    <div class="login">
                        <div style="color: blue; font-size: 30px;background-color: activecaption; margin-bottom: 10px; "><b>Choose Subject</b></div>
                        ...
                        <table>
                            ...
                            <input style="font-size: 25px; background-color: aqua; border-style: solid; width: 110px; border-radius: 10px; border-color: red;" type="submit" value="Choose"/>
                        </form>
                    </div>
                </div>
