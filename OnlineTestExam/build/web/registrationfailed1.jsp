    ...
    <center>
        <div class="main">
            ...
            <div class="body" style="background-image: url(resources/images/background.jpg);">
                ...
                <div class="contents">
                    <div class="signout" style="width: 500px; margin-right: 130px; margin-left: 100px;">
                        UserName Or Password Is Incorrect.. Try Again!!
                        <br/>
                        <%
                        String login_error=(String)session.getAttribute("login_error");
                        if(login_error=="admin")
                        {%>
                        <a style="margin-left: 170px; padding: 10px;" href="adminlogin.jsp"><b>LOGIN</b></a>
                        <%}
                        else{%>
                        <a style="margin-left: 170px; padding: 10px;" href="login.jsp"><b>LOGIN</b></a>
                        <% } 
                        %>
                    </div>
                </div>
